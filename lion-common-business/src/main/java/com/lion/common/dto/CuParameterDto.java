...
//    @Pattern(regexp = "[A-Za-z0-9\\-]{1,32}", message = "编码只能是1-32个(英文/数字)字符", groups = {Validator.Insert.class, Validator.Update.class})
...
//    @Pattern(regexp = "[A-Za-z0-9\\-]{1,32}", message = "名称只能是1-32个(英文/数字)字符", groups = {Validator.Insert.class, Validator.Update.class})
